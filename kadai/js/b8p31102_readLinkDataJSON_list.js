$(function(){
	$("main").ready(function(){
		...
		var detail_page_html = "b8p31102_list.html"; //?id=1等と付けて各施設のデータを読み取るようにすること
		...
		var resource_uri = "http://linkdata.org/work/rdf1s8295i"; //データIDにあたるURLの部分をここに書く
    	...
    	alert("エラー：" + textStatus+"\n以下のURLにアクセスできませんでした．b8p31102_readLinkDataJSON_list.jsの中のurlの値を変更してください．"+url);
		});
	});
});
